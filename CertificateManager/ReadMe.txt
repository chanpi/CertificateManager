========================================================================
 ダイナミック リンク ライブラリ: CertificateManager プロジェクトの概要
========================================================================

この CertificateManager DLL は、AppWizard により作成されました。

このファイルには、CertificateManager 
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、CertificateManager.pch 
